/**
 * LLM Assessment Extraction — prompt helpers
 *
 ...
 *
 * buildExtractionPrompt() is retained as a pure function for unit-test
 * coverage and debugging.
 */

import type { FormTemplate } from "./types.js";

export type { ExtractionResult, AssessmentOutput } from "./types.js";
